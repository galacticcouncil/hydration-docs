...
There are two public RPC nodes which are maintaned by HydraDX and our partners. You can use these nodes for interacting with Snakenet. You can directly connect to a public node with the Polkadot.JS app by clicking on the links below:
...
To access a public RPC node manually, open the [Polkadot.JS app](https://polkadot.js.org/apps/) and click in the upper left corner to change the network.
