...
Sie können Polkadot/apps verwenden um sich mit ihrem Lokalen HydraDX Node zu verbinden. Dafür ist es nötig Zugang zum Port `9944`zu haben, welcher für RPC Websocket verbindungen verwendet wird.
:::warning
